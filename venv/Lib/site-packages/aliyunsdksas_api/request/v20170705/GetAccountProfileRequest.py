...
class GetAccountProfileRequest(RpcRequest):
	...
	def get_AccessTimestamp(self):
		return self.get_query_params().get('AccessTimestamp')

	def set_AccessTimestamp(self,AccessTimestamp):
		self.add_query_param('AccessTimestamp',AccessTimestamp)
